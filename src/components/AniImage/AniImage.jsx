...
import { IntroBrain,IntroFeatured,IntroFrontLayer } from "../../images/images";
...
timing:{duration:2500,iterations:Infinity,direction:'alternate',easing:"eas-in-out"},
    ...
    return(
        <div className={styles.container}>
            <div className={styles.leftContainer}>
                ...
                <Typography variant="h5" style={{color:'#ffffff'}} className= {styles.heading3}> Enhance your communications with psychology-based copywriting and UX writing</Typography>
